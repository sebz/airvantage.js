...
var LIFECYCLE_OPERATIONS = ["activate", "suspend", "resume", "terminate"];
...
// e.g. AirVantage.prototype.suspendSSystems = function(data)
_.each(LIFECYCLE_OPERATIONS, function(operationName) {
