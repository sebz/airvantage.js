...
var BASE_API_V2_URL = "api/v2";
var RESOURCES = ["systems", "gateways", "subscriptions", "applications", "datasets", "settings", "operations", "profiles", "users", "operatoraccounts", "smsaccounts"];
var EDITABLE_RESOURCES = _.without(RESOURCES, "operations", "connections");
var SUB_RESOURCES = {
    applications: ["communication", "data"]
};
var SUBSCRIPTION_OPERATIONS = ["activate", "synchronize", "suspend", "restore", "terminate"];
var SYSTEM_LIFECYCLE_OPERATIONS = ["activate", "suspend", "resume", "terminate"];
...
AirVantage.prototype.createAlertRule = function(data) {
    var url = this.serverUrl + "/" + BASE_API_V2_URL + "/alertrules";
    var query = {
...
AirVantage.prototype.editAlertRule = function(uid, data) {
    var url = this.serverUrl + "/" + BASE_API_V2_URL + "/alertrules/" + uid;
    var query = {
        body: JSON.stringify(data),
        headers: {
            "Content-type": "application/json"
...
_.each(SYSTEM_LIFECYCLE_OPERATIONS, function(operationName) {
    var methodName = operationName + "Systems";
...
_.each(SUBSCRIPTION_OPERATIONS, function(operationName) {
